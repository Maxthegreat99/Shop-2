...
public class Lang
{
    ...
    private static Dictionary<string, string> _message = new Dictionary<string, string>
    {
        ...
        {"PlayerCommandHelp5", "{0}{1} {2} - Attempts to sell your currently held attempt to the shop you are currently in - Aliases: s" },
        {"PlayerCommandHelp6", "{0}{1} {2} - Attempts to confirm the current buy action being executed - Aliases: co " },
        ...
        {"ShopOwnerCommandHelp8", "{0}{1} {2} (Item ID of the item to buy from players) (amount of item you want to buy before players are unable to sell them to you) (price at whcih you are willing to buy the item) - adds a sell item to the shop that players can sell to you from your shop, "},
