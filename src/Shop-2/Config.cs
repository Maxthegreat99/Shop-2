...
public class Lang
{
    ...
    private static Dictionary<string, string> _message = new Dictionary<string, string>
    {
        ...
        {"PlayerCommandHelp", "【[c/90EE90:Store Command Usage:]】\n> '{0}{1} {2} (page)' - lists the shops currently open in the world - Aliases: listregs, lr"},
        {"PlayerCommandHelp2", "\n> '{0}{1} {2}' - Subcommand allowing you to create shops of your own at a fee - Aliases: c" },
        {"PlayerCommandHelp1", "\n> '{0}{1} {2}' - lists the buyable/sellable items in the shop you are currently in - Aliases: listi, li"},
        {"PlayerCommandHelp3", "\n> '{0}{1} {2} (Category)' - Changes the category of items you want to buy in the shop you are currently in - Aliases: cat, ct" },
        {"PlayerCommandHelp4", "\n> '{0}{1} {2} (Shopping item index / shopping item name) (amount of items you want to buy)' - Sends you a confirmation message to buy the specified amount of items stated\nwith the price it would cost - Aliases: b"},
        {"PlayerCommandHelp5", "\n> '{0}{1} {2}' - semds you a confirmation message to sell your currently held attempt to the shop you are currently in - Aliases: s" },
        {"PlayerCommandHelp6", "\n> '{0}{1} {2}' - Attempts to confirm the current buy/sell action being executed - Aliases: co " },
        {"ShopOwnerCommandHelp7", "\n> '{0}{1} {2}' (price) (category) - attempts to either refill an already added buy item or add a new buy item to the shop, you can use notation like 1p (for one platinum in seconomy\nmoney), 1g (for one gold), 12p1g5s(for 12 platinum, one gold and 5 silver) etc... to represent the price value - Aliases: abi" },
        {"ShopOwnerCommandHelp8", "\n> '{0}{1} {2}' (Item ID of the item to buy from players) (amount of item you want to buy before players are unable to sell them to you) (price at whcih you are willing to buy the item) - adds a sell item to your shop, that players can sell to you from it, when players sell to you money for each item is deducted from your account and the items sold are stored in a chest that you need to set, players can sell to you while you are offline. - Aliases: asi"},
        {"ShopOwnerCommandHelp9", "\n> '{0}{1} {2}' - Subcommand allowing for modifying of each item of your shop via their shop item ID (they are showed via item listing) - Aliases: mi" },
        {"ShopOwnerCommandHelp10", "\n> '{0}{1} {2}' - Subcommand allowing for modifying the shop in general, resizing, deleting items etc... Aliases: ms" },
        {"ShopOwnerCommandHelp11", "\nShop command alias: str" },
        {"NotInAShop", "You are currently not in a shop!"},
        {"ListRegionsMessage1", "Shops ({0}/{1}):" },
        {"ListRegionsMessage2","【{0}】 Description: [c/90EE90:{1}]\nOwned by: [c/90EE90:{2}]" },
        {"ListRegionsMessage3","Type '{0}{1} {2} {{0}}' for more." },
        {"ListRegionsMessage4","There are no shops to display." },
        {"ListItemsMessage1", "These are the items and categories currently present in 【[c/90EE90:{0}]】" },
        {"ListItemsMessage2", "These are the items from the category 【[c/90EE90:{0}]】 currently present in 【[c/90EE90:{1}]】" },
        {"ListItemsMessage17", "These are the items currently present in 【[c/90EE90:{0}]】"},
        ...
        {"ListItemsMessage7", "【[c/90EE90:CATEGORIES]】" },
        {"ListItemsMessage8", "【[c/90EE90:BUY ITEMS]】" },
        {"ListItemsMessage9", "Type '{0}{1} {2} (category name / index)' to choose a category!" },
        {"ListItemsMessage10", "[c/FF00FF:Price:]"},
        {"ListItemsMessage11", "Warning: keep space in your inventory while buying if you dont want items to drop on you!" },
        {"ListItemsMessage12", "【[c/90EE90:SELL ITEMS]】"},
        ...
        {"CategoryMessage3", "Successfully switched to category 【[c/90EE90:{0}]】!" },
        ...
        {"ModifyItemMessage1", "【[c/90EE90:Command Usage:]】\n> '{0}{1} {2} (Shopping item ID) price (price you want the item to be set to)' - modifies the price of the specified item in the shop (you can write it in\nnumbers or like this : 1p for 1 platinum, 1g2s for 1 gold and 2 silver etc...)\n\n> '{0}{1} {2} (Shopping item ID) category (category you want the item to be set to)' - modifies the category of the item in the shop\n\n> '{0}{1} {2} (Shopping item ID) chest' - allows you to modify/set the location of the stocks chest if the item is being sold, if the item is an item your shop is buying it will set the location of the chest in which items will apear when players sell to you\n\n> '{0}{1} {2} (Shopping item ID) priceitem (item ID) (the amount of said price items needed to but the shopping item)' - sets an item as price for the specified shopping item on top of the already existing money price, the amount argument specifies how many of the price item you have said must the player pay to buy your item, the item is taken from their selected item hotbar slot,\nthe item amount cannot exceed the item's max stack, this will also have you set a price chest for where these price items will appear\n\n> '{0}{1} {2} (Shopping item ID) pricechest' - if the item has a priceitem already set it allows you to reset the chest in which the price items will apear when the players buy from you." },
        {"ModifyItemMessage2", "\n> '{0}{1} {2} (Shopping item ID) bossreq (NPC IDs in a list ex. {0}{1} {2} 23 bossreq 50 13 222)' - sets the bosses that need to have been killed already for the item to be buyable / sellable" },
        ...
        {"CreateShopMessage1", "【[c/90EE90:Command Usage:]】\n> '{0}{1} {2} set 1' - Sets the first point of the rectangle determining the shop region you want to create\n\n> '{0}{1} {2} set 2' - Sets the second point of the rectangle determining the shop region you want to create\n\n> '{0}{1} {2} confirm (Shop name)' - Attempts to create a shop region with the points you have set, you can user multiple parameters to set the shop name, like this:\n '{0}{1} {2} confirm Shop Name'." },
        ...
        {"CreateShopMessage6", "Successfully set the first point at X: {0} Y: {1}" },
        ...
        {"ModifyShopMessage1", "【[c/90EE90:Command Usage:]】\n> '{0}{1} {2} description (shop description)' - modifies the shop's description which is showed to players when listing all the different shops present in the world\n\n> '{0}{1} {2} greet (shop greeting)' - modifies the message showed to players upon entering your shop\n\n> '{0}{1} {2} removeitem (shop item ID)' - Removes the specified item from listing in the shop and gives back you the items stored virtually in the store if its a buying item\n\n> '{0}{1} {2} deleteshop' - sends you a confirmation request to delete the shop, you will be given the stored items back, the region will also be deleted\n\n> '{0}{1} {2} transferownership (player name)' - sends you a confirmation requet to transfers ownership of the shop to the specified player, you will no longer be able to modify this shop\n\n> '{0}{1} {2} resizeshop' - sends a confirmation message to resize the shop using set points, you need to do '{0}{1} {3} set <1/2>' before typing out this command, the price of resizing\nthe shop depends on the current area of the shop and the new area, if the area you have set with set <1/2> is bigger than the current area of your shop the price\nwill be calculated using the extra area you are gaining, if its smaller the price is 0\n\n> '{0}{1} {2} confirm' - confirmation for the delete and transferownership commands, actions cannot be reversed after this command is executed\n\n> '{0}{1} {2} trust (player name)' - allows/prevents the specified player to build in your shop region, use this command on a player that can already\nbuild in your shop region to prevent them from building in it" },
        ...
        {"ConfirmSellMessage5", "Checking Stock chest validity of item [i:{0}]" },
        ...
        {"Greet", "From Shop 【[c/90EE90:{0}]】: {1} " },
        {"Greet1", "Welcome to your shop, 【[c/90EE90:{0}]】!" },
        {"Help", "Provides multiple store interaction methods, most are available only if you are in a shop or in a shop you own" },
        {"BuyMessage22", "There are no items to buy in this category" }
