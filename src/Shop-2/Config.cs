...
public class Lang
{
    ...
    private static Dictionary<string, string> _message = new Dictionary<string, string>
    {
        ...
        {"PlayerCommandHelp", "Store Command Usage:\n[Shop2] {0}{1} {2} (page) - lists the shops currently open in the world - Aliases: listregs, lr"},
        {"PlayerCommandHelp2", "{0}{1} {2} - Subcommand allowing you to create shops of your own at a fee - Aliases: c" },
        {"PlayerCommandHelp1", "{0}{1} {2} - lists the buyable/sellable items in the shop you are currently in - Aliases: listi, li"},
        {"PlayerCommandHelp3", "{0}{1} {2} (Category) - Changes the category of items you want to buy in the shop you are currently in - Aliases: cat, ct" },
        {"PlayerCommandHelp4", "{0}{1} {2} (Shopping item index / shopping item name) (amount of items you want to buy) - Sends you a confirmation message to buy the specified amount of items stated with the price it would cost - Aliases: b"},
        {"PlayerCommandHelp5", "{0}{1} {2} - semds you a confirmation message to sell your currently held attempt to the shop you are currently in - Aliases: s" },
        {"PlayerCommandHelp6", "{0}{1} {2} - Attempts to confirm the current buy/sell action being executed - Aliases: co " },
        {"ShopOwnerCommandHelp7", "{0}{1} {2} (price) - attempts to either refill an already added buy item or add a new buy item to the shop, you can use notation like 1p (for one platinum in seconomy money), 1g (for one gold), 12p1g5s(for 12 platinum, one gold and 5 silver) etc... to represent the price value - Aliases: abi" },
        {"ShopOwnerCommandHelp8", "{0}{1} {2} (Item ID of the item to buy from players) (amount of item you want to buy before players are unable to sell them to you) (price at whcih you are willing to buy the item) - adds a sell item to your shop, that players can sell to you from it, when players sell to you money for each item is deducted from your account and the items sold are stored in a chest that you need to set, players can sell to you while you are offline. - Aliases: asi"},
        {"ShopOwnerCommandHelp9", "{0}{1} {2} - Subcommand allowing for modifying of each item of your shop via their shop item ID (they are showed via item listing) - Aliases: mi" },
        {"ShopOwnerCommandHelp10", "{0}{1} {2} - Subcommand allowing for modifying the shop in general, resizing, deleting items etc... Aliases: ms" },
        {"ShopOwnerCommandHelp11", "Shop command alias: str" },
